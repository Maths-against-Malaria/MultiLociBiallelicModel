# Title        : Data generator for the simulations
# Objective    : Generates the dataset used for the simulation
# Created by   : Christian Tsoungui Obama, Kristan. A. Schneider
# Created on   : 03.04.21
# Last modified: 22.12.21

hapl <- function(n){
  # Given a number of loci n, this function creates
  # a table of allpossible haplotypes
  H <- array(0,c(2^n,n))
  H[1:2,1] <- c(0,1)
  for(k in 2:n){
